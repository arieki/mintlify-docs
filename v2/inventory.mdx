...
<Columns cols={2}>
  <Card title="Predictive Stock Levels" icon="chart-line">
    AI forecasts when you'll run out of ingredients based on usage patterns and trends.
  </Card>
  <Card title="Automated Reordering" icon="shopping-cart">
    Smart ordering system that automatically places orders based on predicted needs and supplier lead times.
  </Card>
  <Card title="Usage Predictions" icon="lightbulb">
    Machine learning analyzes historical data to predict ingredient needs for upcoming periods.
  </Card>
