...
<Steps>
  <Step title="Select Forecast Horizon">
    ...
    <Columns cols={3}>
      <Card title="Short-term (7 days)">
        Daily production planning
      </Card>
      <Card title="Medium-term (14 days)">
        Ingredient ordering and staffing
      </Card>
      <Card title="Long-term (30+ days)">
        Strategic planning and seasonal prep
      </Card>
    </Columns>
  </Step>
...
<AccordionGroup>
  <Accordion title="Accuracy Metrics" defaultOpen>
...
<AccordionGroup>
  <Accordion title="Centralized Dashboard" defaultOpen>
...
<Columns cols={2}>
  ...
  <Card title="Dedicated Account Manager" icon="user">
    Personal contact for enterprise customers
  </Card>
  <Card title="Professional Services" icon="wrench">
